...
<form method="post" action="index.php">
    ...
    <input id="lastName" name="lastName" type="text" placeholder="Ranou">
    <div class="w-100 p-1"></div>
    <label for="firstName">Votre prénom :</label>
    <div class="w-100 p-1"></div>
    <input id="firstName" name="firstName" type="text" placeholder="Monique">
    <div class="w-100 p-1"></div>
    <label for="birthDate">Votre date de naissance :</label>
    <div class="w-100 p-1"></div>
    <input id="birthDate" name="birthDate" type="text" placeholder="01/01/1969">
    <div class="w-100 p-1"></div>
    ...
    <div class="w-100 p-1"></div>
    <label for="diplomas">Vos diplômes :</label>
    <div class="w-100 p-1"></div>
    ...
    <div class="w-100 p-1"></div>
    <label for="badgeNb">Votre nombre de badges Codecademy :</label>
    <div class="w-100 p-1"></div>
    <input id="badgeNb" name="badgeNb">
    <div class="w-100 p-1"></div>
    <label for="codecademyLink">Lien vers votre profil Codecademy :</label>
    <div class="w-100 p-1"></div>
    <input id="codecademyLink" name="codecademyLink">
    <div class="w-100 p-1"></div>
    <label for="ifHero">Si vous étiez une héroïne/un héros, qui seriez-vous et pourquoi ?</label>
    <div class="w-100 p-1"></div>
    <textarea id="ifHero" name="ifHero" cols="40" rows="6"></textarea>
    <div class="w-100 p-1"></div>
    <label for="personalHack">Racontez-nous un de vos "hacks" (pas forcément technique ou informatique) :</label>
    <div class="w-100 p-1"></div>
    <textarea id="personalHack" name="personalHack" cols="40" rows="6"></textarea>
    <div class="w-100 p-1"></div>
    <label for="previousDevExperience">Avez vous déjà eu une expérience avec la programmation et/ou l'informatique avant de remplir ce formulaire ?</label>
    <div class="w-100 p-1"></div>
    <textarea id="previousDevExperience" name="previousDevExperience" cols="40" rows="6"></textarea>
    <div class="w-100 p-1"></div>
